...
const Footer = () => {
  ...
  return (
    <footer className="bg-black text-white">
      {/* Newsletter Section */}
      <div className="border-t border-b border-gray-800 py-12 px-4">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <form onSubmit={handleSubscribe} className="flex gap-3 w-full md:w-auto">
            <input
              ...
              className="px-6 py-3 bg-gray-900 border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-blue-600 transition flex-1 md:flex-none min-w-64"
              required
            />
            <button
              type="submit"
              className="px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition duration-200 flex items-center gap-2 whitespace-nowrap"
            >
              Subscribe
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <div className="flex gap-4">
                <a href="#" className="w-10 h-10 bg-gray-900 hover:bg-gray-800 rounded-lg flex items-center justify-center text-gray-400 hover:text-white transition">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><a href="#" className="text-gray-400 hover:text-white transition">Innovation Labs</a></li>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><a href="#" className="text-gray-400 hover:text-white transition">AIFAG Suite</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white transition">LifeOS</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><a href="#" className="text-gray-400 hover:text-white transition">Collaborate</a></li>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
              ...
              <div className="flex flex-col md:flex-row gap-6 items-start md:items-center">
                ...
                <a href="mailto:pmo@aifagenlabs.com" className="flex items-center gap-2 text-gray-400 hover:text-white transition">
                  ...
                  <span className="text-sm">pmo@aifagenlabs.com</span>
                </a>
                <a href="tel:+919490868555" className="flex items-center gap-2 text-gray-400 hover:text-white transition">
                  ...
                  <span className="text-sm">+91 9490868555</span>
                </a>
              </div>
