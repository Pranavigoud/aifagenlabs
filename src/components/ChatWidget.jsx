      ...
      <div className="bg-gray-900 rounded-t-2xl md:rounded-t-3xl p-4 md:p-6 border-b border-gray-700 flex items-center justify-between flex-shrink-0">
        <div className="flex items-center gap-2 md:gap-3 min-w-0">
          ...
          <div className="min-w-0">
            <p className="text-white font-semibold text-xs md:text-sm truncate">AIFA Assistant</p>
            <p className="text-gray-400 text-xs">Always here to help</p>
          </div>
        </div>
        <button
          onClick={() => setIsChatOpen(false)}
          className="w-8 h-8 bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white rounded-full flex items-center justify-center transition-all duration-200 flex-shrink-0"
